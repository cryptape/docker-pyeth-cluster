...
RUN git clone https://github.com/gguoss/pyrlp /apps/pyrlp
WORKDIR /apps/pyrlp
RUN pip install -e .

RUN git clone https://github.com/gguoss/pydevp2p /apps/pydevp2p
WORKDIR /apps/pydevp2p
RUN pip install -e .

RUN git clone https://github.com/gguoss/pyethereum /apps/pyethereum
WORKDIR /apps/pyethereum
RUN pip install -e .

RUN git clone https://github.com/gguoss/pyethapp /apps/pyethapp
